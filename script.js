...
async function sayOpeningOnce() {
  ...
  const lines = [
    "สวัสดีครับ ผมน้องม่านนะครับ ถ้ามีอะไรสงสัยถามได้เลยครับ หรือกดปุ่มด้านล่าง จะมีเสียงทีมช่างคอยอธิบายโซนบริการต่างๆ ของร้านอรุณีผ้าม่านให้ฟังครับ",
    "ยินดีต้อนรับสู่ร้านอรุณีผ้าม่านครับ แม้ชื่อจะมีคำว่าผ้าม่าน แต่บริการครบวงจร ทั้งผ้าม่าน ผนัง พื้น ออกแบบ ติดตั้ง และดูแลหลังการขายครับ",
    "ผมช่วยดีไซน์และจัดวัสดุทั้งห้องให้จบที่เดียว ทีมช่างใจดี สายชิลล์ ปรึกษาได้ทุกเรื่องตั้งแต่ผ้าม่าน วอลล์ ไปจนถึงพื้นและงานติดตั้งครับ",
    "อยากดูโทนสี หรือขอคำแนะนำติดตั้ง ผมช่วยเล่าและเลือกตัวอย่างให้ได้ทันทีครับ",
    "ส่งรูปหน้างานมาได้เลยครับ ผมจะช่วยวิเคราะห์และแนะนำวัสดุที่เหมาะ พร้อมส่งต่อให้ทีมช่างได้ครับ",
    "คุยกับน้องม่านได้ทั้งเรื่องผ้าม่าน วอลล์ พื้น หรือบริการติดตั้ง-หลังการขาย บอกสิ่งที่ต้องการได้เลยครับ"
  ];
